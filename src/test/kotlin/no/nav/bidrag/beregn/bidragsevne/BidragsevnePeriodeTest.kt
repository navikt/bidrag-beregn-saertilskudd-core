...
internal class BidragsevnePeriodeTest {
    ...
    fun testGrunnlagMedAvvik() {
        ...
        assertAll(
            ...
            Executable { assertThat(avvikListe[4].avvikTekst).isEqualTo("Siste dato i antallBarnIEgetHusholdPeriodeListe (2020-01-01) er før beregnDatoTil (2021-01-01)") },
    ...
    private fun lagBostatusGrunnlag(): List<BostatusPeriode> {
        ...
        bostatusPeriodeListe.add(
            BostatusPeriode(
                ...
                bostatusKode = BostatusKode.MED_ANDRE
            )
        )
        bostatusPeriodeListe.add(
            BostatusPeriode(
        ...
        saerfradragPeriodeListe
            .add(
                SaerfradragPeriode(
                    ...
                    periodeDatoFraTil = Periode(datoFom = LocalDate.parse("2001-01-01"), datoTil = LocalDate.parse("2017-01-01")),
                    saerfradragKode = SaerfradragKode.HELT
                )
            )
        saerfradragPeriodeListe
            .add(
    ...
    private fun lagSjablonGrunnlag(): List<SjablonPeriode> {
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    navn = SjablonTallNavn.UNDERHOLD_EGNE_BARN_I_HUSSTAND_BELOP.navn,
                    nokkelListe = emptyList(),
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    navn = SjablonTallNavn.MINSTEFRADRAG_INNTEKT_BELOP.navn,
                    nokkelListe = emptyList(),
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                sjablonPeriode = Periode(datoFom = LocalDate.parse("2018-07-01"), datoTil = LocalDate.parse("2019-06-30")),
                sjablon = Sjablon(
                    navn = SjablonTallNavn.PERSONFRADRAG_KLASSE1_BELOP.navn,
                    nokkelListe = emptyList(),
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = emptyList(),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.navn, verdi = BigDecimal.valueOf(169000)),
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = emptyList(),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.navn, verdi = BigDecimal.valueOf(237900)),
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = emptyList(),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.navn, verdi = BigDecimal.valueOf(598050)),
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = emptyList(),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.navn, verdi = BigDecimal.valueOf(962050)),
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = emptyList(),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.navn, verdi = BigDecimal.valueOf(174500)),
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = emptyList(),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.navn, verdi = BigDecimal.valueOf(245650)),
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = emptyList(),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.navn, verdi = BigDecimal.valueOf(617500)),
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = emptyList(),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.navn, verdi = BigDecimal.valueOf(964800)),
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = emptyList(),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.navn, verdi = BigDecimal.valueOf(180800)),
                        SjablonInnhold(navn = SjablonInnholdNavn.SKATTESATS_PROSENT.navn, verdi = BigDecimal.valueOf(1.9))
                    )
                )
            )
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = emptyList(),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.navn, verdi = BigDecimal.valueOf(254500)),
                        SjablonInnhold(navn = SjablonInnholdNavn.SKATTESATS_PROSENT.navn, verdi = BigDecimal.valueOf(4.2))
                    )
                )
            )
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = emptyList(),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.navn, verdi = BigDecimal.valueOf(639750)),
                        SjablonInnhold(navn = SjablonInnholdNavn.SKATTESATS_PROSENT.navn, verdi = BigDecimal.valueOf(13.2))
                    )
                )
            )
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = emptyList(),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.navn, verdi = BigDecimal.valueOf(999550)),
                        SjablonInnhold(navn = SjablonInnholdNavn.SKATTESATS_PROSENT.navn, verdi = BigDecimal.valueOf(16.2))
                    )
                )
            )
        ...
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = listOf(SjablonNokkel(SjablonNokkelNavn.BOSTATUS.navn, "EN")),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.BOUTGIFT_BELOP.navn, verdi = BigDecimal.valueOf(9303)),
                        SjablonInnhold(navn = SjablonInnholdNavn.UNDERHOLD_BELOP.navn, verdi = BigDecimal.valueOf(8657))
                    )
                )
            )
        )
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    navn = SjablonNavn.BIDRAGSEVNE.navn,
                    nokkelListe = listOf(SjablonNokkel(SjablonNokkelNavn.BOSTATUS.navn, "GS")),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.BOUTGIFT_BELOP.navn, verdi = BigDecimal.valueOf(5698)),
                        SjablonInnhold(navn = SjablonInnholdNavn.UNDERHOLD_BELOP.navn, verdi = BigDecimal.valueOf(7330))
                    )
                )
            )
        )
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = listOf(SjablonNokkel(SjablonNokkelNavn.BOSTATUS.navn, "EN")),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.BOUTGIFT_BELOP.navn, verdi = BigDecimal.valueOf(9591)),
                        SjablonInnhold(navn = SjablonInnholdNavn.UNDERHOLD_BELOP.navn, verdi = BigDecimal.valueOf(8925))
                    )
                )
            )
        )
        sjablonPeriodeListe.add(
            SjablonPeriode(
                ...
                sjablon = Sjablon(
                    ...
                    nokkelListe = listOf(SjablonNokkel(SjablonNokkelNavn.BOSTATUS.navn, "GS")),
                    innholdListe = listOf(
                        SjablonInnhold(navn = SjablonInnholdNavn.BOUTGIFT_BELOP.navn, verdi = BigDecimal.valueOf(5875)),
                        SjablonInnhold(navn = SjablonInnholdNavn.UNDERHOLD_BELOP.navn, verdi = BigDecimal.valueOf(7557))
                    )
                )
            )
        )
