...
public class BPsAndelSaertilskuddPeriodeTest {
  ...
  private void lagGrunnlagMedInntekterTilJustering(String rolle) {
    ...
    if (rolle.equals("BP")) {
      ...
      inntektBPPeriodeListe = singletonList(new InntektPeriode("Inntekt_20180101", new Periode(beregnDatoFra, beregnDatoTil),
    ...
    if (rolle.equals("BM")) {
      ...
      inntektBMPeriodeListe = singletonList(new InntektPeriode("Inntekt_20180101", new Periode(beregnDatoFra, beregnDatoTil),
  ...
  private List<InntektPeriode> lagJustertInntektGrunnlag() {
    ...
    inntektPeriodeListe.add(
        new InntektPeriode("Inntekt_20180101", new Periode(LocalDate.parse("2018-01-01"), null),
    ...
    inntektPeriodeListe.add(
        new InntektPeriode("Inntekt_20190101", new Periode(LocalDate.parse("2019-01-01"), null),
    ...
    inntektPeriodeListe.add(
        new InntektPeriode("Inntekt_20200101", new Periode(LocalDate.parse("2020-01-01"), null),
