...
class BidragsevnePeriodeTest {
  ...
  void testGrunnlagOk() {
    ...
    assertAll(
        ...
        () -> assertThat(resultat.getResultatPeriodeListe().get(0).getResultatBeregning().getResultatEvneBelop()).isEqualTo(BigDecimal.valueOf(3749)),
        ...
        () -> assertThat(resultat.getResultatPeriodeListe().get(1).getResultatGrunnlagBeregning().getBostatus().getKode())
            .isEqualTo(BostatusKode.ALENE),

        () -> assertThat(resultat.getResultatPeriodeListe().get(2).getResultatDatoFraTil().getDatoFom()).isEqualTo(LocalDate.parse("2019-02-01")),
        ...
        () -> assertThat(resultat.getResultatPeriodeListe().get(3).getResultatDatoFraTil().getDatoFom()).isEqualTo(LocalDate.parse("2019-04-01")),
        ...
        () -> assertThat(resultat.getResultatPeriodeListe().get(4).getResultatDatoFraTil().getDatoFom()).isEqualTo(LocalDate.parse("2019-05-01")),
        ...
        () -> assertThat(resultat.getResultatPeriodeListe().get(5).getResultatDatoFraTil().getDatoFom()).isEqualTo(LocalDate.parse("2019-07-01")),
  ...
  private List<InntektPeriode> lagInntektGrunnlag() {
    ...
    inntektPeriodeListe
        .add(new InntektPeriode("Inntekt_20030101", new Periode(LocalDate.parse("2003-01-01"), LocalDate.parse("2004-01-01")),
            InntektType.INNTEKTSOPPLYSNINGER_ARBEIDSGIVER, BigDecimal.valueOf(666000)));
    inntektPeriodeListe
        .add(new InntektPeriode("Inntekt_20040101", new Periode(LocalDate.parse("2004-01-01"), LocalDate.parse("2016-01-01")),
            InntektType.INNTEKTSOPPLYSNINGER_ARBEIDSGIVER, BigDecimal.valueOf(555000)));
    inntektPeriodeListe
        .add(new InntektPeriode("Inntekt_20160101", new Periode(LocalDate.parse("2016-01-01"), LocalDate.parse("2019-01-01")),
            InntektType.INNTEKTSOPPLYSNINGER_ARBEIDSGIVER, BigDecimal.valueOf(444000)));
    inntektPeriodeListe
        .add(new InntektPeriode("Inntekt_20190101", new Periode(LocalDate.parse("2019-01-01"), LocalDate.parse("2019-04-01")),
            InntektType.INNTEKTSOPPLYSNINGER_ARBEIDSGIVER, BigDecimal.valueOf(666000)));
    inntektPeriodeListe
        .add(new InntektPeriode("Inntekt_20190401", new Periode(LocalDate.parse("2019-04-01"), LocalDate.parse("2020-01-01")),
            InntektType.INNTEKTSOPPLYSNINGER_ARBEIDSGIVER, BigDecimal.valueOf(666001)));
    inntektPeriodeListe
        .add(new InntektPeriode("20190501", new Periode(LocalDate.parse("2019-05-01"), LocalDate.parse("2020-01-01")),
            InntektType.OVERGANGSSTONAD, BigDecimal.valueOf(2)));
    inntektPeriodeListe
        .add(new InntektPeriode("20190701", new Periode(LocalDate.parse("2019-07-01"), LocalDate.parse("2020-01-01")),
  ...
  private List<BarnIHustandPeriode> lagAntallBarnIEgetHusholdGrunnlag() {

    var antallBarnIEgetHusholdPeriodeListe = new ArrayList<BarnIHustandPeriode>();

    antallBarnIEgetHusholdPeriodeListe
        .add(new BarnIHustandPeriode("BarnIHusstand", new Periode(LocalDate.parse("2001-01-01"), LocalDate.parse("2017-01-01")), 1));
    antallBarnIEgetHusholdPeriodeListe
        .add(new BarnIHustandPeriode("BarnIHusstand", new Periode(LocalDate.parse("2017-01-01"), LocalDate.parse("2020-01-01")), 2));
  ...
  private List<SaerfradragPeriode> lagSaerfradragGrunnlag() {
    ...
    saerfradragPeriodeListe
        .add(new SaerfradragPeriode("Saerfradrag", new Periode(LocalDate.parse("2001-01-01"), LocalDate.parse("2017-01-01")), SaerfradragKode.HELT));
    saerfradragPeriodeListe
        .add(new SaerfradragPeriode("Saerfradrag", new Periode(LocalDate.parse("2017-01-01"), LocalDate.parse("2020-01-01")), SaerfradragKode.HELT));
  ...
  private List<SjablonPeriode> lagSjablonGrunnlag() {
    ...
    sjablonPeriodeListe.add(new SjablonPeriode(
        ...
        new Sjablon(SjablonTallNavn.FORDEL_SKATTEKLASSE2_BELOP.getNavn(), emptyList(),
            Collections.singletonList(new SjablonInnhold(SjablonInnholdNavn.SJABLON_VERDI.getNavn(), BigDecimal.valueOf(8848))))));

    sjablonPeriodeListe.add(new SjablonPeriode(
        new Periode(LocalDate.parse("2013-01-01"), null),
        new Sjablon(SjablonTallNavn.FORDEL_SKATTEKLASSE2_BELOP.getNavn(), emptyList(),
            Collections.singletonList(new SjablonInnhold(SjablonInnholdNavn.SJABLON_VERDI.getNavn(), BigDecimal.valueOf(0))))));
    ...
    sjablonPeriodeListe.add(new SjablonPeriode(
        ...
        new Sjablon(SjablonTallNavn.TRYGDEAVGIFT_PROSENT.getNavn(), emptyList(),
            Collections.singletonList(new SjablonInnhold(SjablonInnholdNavn.SJABLON_VERDI.getNavn(), BigDecimal.valueOf(7.8))))));
    ...
    sjablonPeriodeListe.add(new SjablonPeriode(
        ...
        new Sjablon(SjablonTallNavn.UNDERHOLD_EGNE_BARN_I_HUSSTAND_BELOP.getNavn(), emptyList(),
            Collections.singletonList(new SjablonInnhold(SjablonInnholdNavn.SJABLON_VERDI.getNavn(), BigDecimal.valueOf(3417))))));
    ...
    sjablonPeriodeListe.add(new SjablonPeriode(
        ...
        new Sjablon(SjablonTallNavn.MINSTEFRADRAG_INNTEKT_BELOP.getNavn(), emptyList(),
            Collections.singletonList(new SjablonInnhold(SjablonInnholdNavn.SJABLON_VERDI.getNavn(), BigDecimal.valueOf(57400))))));

    sjablonPeriodeListe.add(new SjablonPeriode(
        new Periode(LocalDate.parse("2017-07-01"), LocalDate.parse("2017-12-31")),
        new Sjablon(SjablonTallNavn.MINSTEFRADRAG_INNTEKT_BELOP.getNavn(), emptyList(),
            Collections.singletonList(new SjablonInnhold(SjablonInnholdNavn.SJABLON_VERDI.getNavn(), BigDecimal.valueOf(75000d))))));

    sjablonPeriodeListe.add(new SjablonPeriode(
        new Periode(LocalDate.parse("2018-01-01"), LocalDate.parse("2018-06-30")),
        new Sjablon(SjablonTallNavn.MINSTEFRADRAG_INNTEKT_BELOP.getNavn(), emptyList(),
            Collections.singletonList(new SjablonInnhold(SjablonInnholdNavn.SJABLON_VERDI.getNavn(), BigDecimal.valueOf(75000))))));

    sjablonPeriodeListe.add(new SjablonPeriode(
        new Periode(LocalDate.parse("2018-07-01"), LocalDate.parse("2019-06-30")),
        new Sjablon(SjablonTallNavn.MINSTEFRADRAG_INNTEKT_BELOP.getNavn(), emptyList(),
            Collections.singletonList(new SjablonInnhold(SjablonInnholdNavn.SJABLON_VERDI.getNavn(), BigDecimal.valueOf(83000))))));
    ...
    sjablonPeriodeListe.add(new SjablonPeriode(
        ...
        new Sjablon(SjablonTallNavn.PERSONFRADRAG_KLASSE1_BELOP.getNavn(), emptyList(),
            Collections.singletonList(new SjablonInnhold(SjablonInnholdNavn.SJABLON_VERDI.getNavn(), BigDecimal.valueOf(54750))))));
    ...
    sjablonPeriodeListe.add(new SjablonPeriode(
        ...
        new Sjablon(SjablonTallNavn.FORDEL_SAERFRADRAG_BELOP.getNavn(), emptyList(),
            Collections.singletonList(new SjablonInnhold(SjablonInnholdNavn.SJABLON_VERDI.getNavn(), BigDecimal.valueOf(13132))))));
    ...
    sjablonPeriodeListe.add(new SjablonPeriode(
        ...
        new Sjablon(SjablonTallNavn.SKATTESATS_ALMINNELIG_INNTEKT_PROSENT.getNavn(), emptyList(),
            Collections.singletonList(new SjablonInnhold(SjablonInnholdNavn.SJABLON_VERDI.getNavn(), BigDecimal.valueOf(23))))));
    ...
    sjablonPeriodeListe.add(new SjablonPeriode(
        ...
        new Sjablon(SjablonNavn.TRINNVIS_SKATTESATS.getNavn(), emptyList(),
            Arrays.asList(new SjablonInnhold(SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.getNavn(), BigDecimal.valueOf(169000)),
                new SjablonInnhold(SjablonInnholdNavn.SKATTESATS_PROSENT.getNavn(), BigDecimal.valueOf(1.4))))));

    sjablonPeriodeListe.add(new SjablonPeriode(
        new Periode(LocalDate.parse("2018-01-01"), LocalDate.parse("2018-12-31")),
        new Sjablon(SjablonNavn.TRINNVIS_SKATTESATS.getNavn(), emptyList(),
            Arrays.asList(new SjablonInnhold(SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.getNavn(), BigDecimal.valueOf(237900)),
                new SjablonInnhold(SjablonInnholdNavn.SKATTESATS_PROSENT.getNavn(), BigDecimal.valueOf(3.3))))));

    sjablonPeriodeListe.add(new SjablonPeriode(
        new Periode(LocalDate.parse("2018-01-01"), LocalDate.parse("2018-12-31")),
        new Sjablon(SjablonNavn.TRINNVIS_SKATTESATS.getNavn(), emptyList(),
            Arrays.asList(new SjablonInnhold(SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.getNavn(), BigDecimal.valueOf(598050)),
                new SjablonInnhold(SjablonInnholdNavn.SKATTESATS_PROSENT.getNavn(), BigDecimal.valueOf(12.4))))));

    sjablonPeriodeListe.add(new SjablonPeriode(
        new Periode(LocalDate.parse("2018-01-01"), LocalDate.parse("2018-12-31")),
        new Sjablon(SjablonNavn.TRINNVIS_SKATTESATS.getNavn(), emptyList(),
            Arrays.asList(new SjablonInnhold(SjablonInnholdNavn.INNTEKTSGRENSE_BELOP.getNavn(), BigDecimal.valueOf(962050)),
                new SjablonInnhold(SjablonInnholdNavn.SKATTESATS_PROSENT.getNavn(), BigDecimal.valueOf(15.4))))));
    ...
    sjablonPeriodeListe.add(new SjablonPeriode(
        ...
        new Sjablon(SjablonNavn.BIDRAGSEVNE.getNavn(), Collections.singletonList(new SjablonNokkel(SjablonNokkelNavn.BOSTATUS.getNavn(), "EN")),
            Arrays.asList(new SjablonInnhold(SjablonInnholdNavn.BOUTGIFT_BELOP.getNavn(), BigDecimal.valueOf(9303)),
                new SjablonInnhold(SjablonInnholdNavn.UNDERHOLD_BELOP.getNavn(), BigDecimal.valueOf(8657))))));
    ...
    sjablonPeriodeListe.add(new SjablonPeriode(
        ...
        new Sjablon(SjablonNavn.BIDRAGSEVNE.getNavn(), Collections.singletonList(new SjablonNokkel(SjablonNokkelNavn.BOSTATUS.getNavn(), "GS")),
            Arrays.asList(new SjablonInnhold(SjablonInnholdNavn.BOUTGIFT_BELOP.getNavn(), BigDecimal.valueOf(5698)),
                new SjablonInnhold(SjablonInnholdNavn.UNDERHOLD_BELOP.getNavn(), BigDecimal.valueOf(7330))))));
  ...
  private void printGrunnlagResultat(BeregnBidragsevneResultat beregnBidragsevneResultat) {
    beregnBidragsevneResultat.getResultatPeriodeListe().stream()
        ...
        .forEach(sortedPR -> System.out.println("Dato fra: " + sortedPR.getResultatDatoFraTil().getDatoFom() + "; " + "Dato til: "
            + sortedPR.getResultatDatoFraTil().getDatoTil() + "; " + "Beløp: " + sortedPR.getResultatBeregning().getResultatEvneBelop()));
  }
