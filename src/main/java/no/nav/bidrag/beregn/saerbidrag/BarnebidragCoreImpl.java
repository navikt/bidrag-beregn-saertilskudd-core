...
import no.nav.bidrag.beregn.saerbidrag.dto.BPsAndelUnderholdskostnadCore;
import no.nav.bidrag.beregn.saerbidrag.dto.BPsAndelUnderholdskostnadPeriodeCore;
import no.nav.bidrag.beregn.saerbidrag.dto.BarnetilleggCore;
...
import no.nav.bidrag.beregn.saerbidrag.dto.BeregnBarnebidragResultatCore;
import no.nav.bidrag.beregn.saerbidrag.dto.BidragsevneCore;
...
import no.nav.bidrag.beregn.saerbidrag.dto.GrunnlagBeregningPerBarnCore;
import no.nav.bidrag.beregn.saerbidrag.dto.GrunnlagBeregningPeriodisertCore;
import no.nav.bidrag.beregn.saerbidrag.dto.ResultatBeregningCore;
import no.nav.bidrag.beregn.saerbidrag.dto.ResultatPeriodeCore;
