...
import no.nav.bidrag.beregn.bpsandelsaerbidrag.dto.BeregnBPsAndelUnderholdskostnadResultatCore;
import no.nav.bidrag.beregn.bpsandelsaerbidrag.dto.InntektCore;
import no.nav.bidrag.beregn.bpsandelsaerbidrag.dto.InntektPeriodeCore;
import no.nav.bidrag.beregn.bpsandelsaerbidrag.dto.ResultatBeregningCore;
import no.nav.bidrag.beregn.bpsandelsaerbidrag.dto.ResultatGrunnlagCore;
import no.nav.bidrag.beregn.bpsandelsaerbidrag.dto.ResultatPeriodeCore;
...
public class BPsAndelUnderholdskostnadCoreImpl implements BPsAndelUnderholdskostnadCore{
  ...
  public BeregnBPsAndelUnderholdskostnadResultatCore beregnBPsAndelUnderholdskostnad(
    ...
    var beregnBPsAndelUnderholdskostnadResultat = new BeregnBPsAndelSaerbidragResultat(Collections.emptyList());
  ...
  private BeregnBPsAndelSaerbidragGrunnlag mapTilBusinessObject(
      BeregnBPsAndelUnderholdskostnadGrunnlagCore beregnBPsAndelUnderholdskostnadGrunnlagCore) {
    ...
    return new BeregnBPsAndelSaerbidragGrunnlag(beregnDatoFra, beregnDatoTil, soknadsbarnPersonId,
  ...
  private BeregnBPsAndelUnderholdskostnadResultatCore mapFraBusinessObject(List<Avvik> avvikListe, BeregnBPsAndelSaerbidragResultat resultat) {
