...
public class SamvaersfradragPeriodeImpl implements SamvaersfradragPeriode {
  ...
  public BeregnSamvaersfradragResultat beregnPerioder(BeregnSamvaersfradragGrunnlag beregnSamvaersfradragGrunnlag) {
    ...
    for (Periode beregningsperiode : perioder) {
      ...
      var samvaersfradragGrunnnlagPerBarnliste = justertSamvaersfradragPeriodeListe.stream()
          ...
          .map(samvaersfradragGrunnnlagPerBarn -> new SamvaersfradragGrunnlagPerBarn(
              samvaersfradragGrunnnlagPerBarn.getReferanse(),
              samvaersfradragGrunnnlagPerBarn.getBarnPersonId(),
              beregnBarnAlder(samvaersfradragGrunnnlagPerBarn.getBarnFodselsdato(),
                  beregningsperiode.getDatoFom()),
              samvaersfradragGrunnnlagPerBarn.getSamvaersklasse()))
          .toList();
      ...
      var beregnSamvaersfradragGrunnlagPeriodisert = new GrunnlagBeregningPeriodisert(samvaersfradragGrunnnlagPerBarnliste, sjablonliste);

      resultatPeriodeListe.add(new ResultatPeriode(beregningsperiode, samvaersfradragBeregning.beregn(beregnSamvaersfradragGrunnlagPeriodisert),
  ...
  public Integer beregnBarnAlder(LocalDate barnFodselsdato, LocalDate beregnDatoFra) {
    return Period.between(barnFodselsdato, beregnDatoFra).getYears();
  }
