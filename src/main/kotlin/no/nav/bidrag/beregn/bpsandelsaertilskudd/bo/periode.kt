...
data class NettoSaertilskuddPeriode(
  ...
  constructor(nettoSaertilskuddPeriode: NettoSaertilskuddPeriode)
      : this(nettoSaertilskuddPeriode.referanse, nettoSaertilskuddPeriode.periodeDatoFraTil.justerDatoer(),
...
data class InntektPeriode(
  ...
  constructor(inntektPeriode: InntektPeriode)
      : this(inntektPeriode.referanse, inntektPeriode.periodeDatoFraTil.justerDatoer(),
