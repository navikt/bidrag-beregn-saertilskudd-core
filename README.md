...
--------|--------------|------------
0.2.0   | Endret       | Lagt til første versjon av beregningslogikk og fjernet soknadsbarnPersonId fra BPs andel av saertilskudd, gjort om input til samvær og sørtilskuddberegning til lister for å få med info om alle barn
